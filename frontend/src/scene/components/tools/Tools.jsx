  ...
  const toolsItems = [
    {
      id: 1,
      name: 'Modifier CRBT',
      description: 'Corriger les valeurs CRBT incorrectes des colis. Entrez le code de suivi du colis que vous souhaitez modifier.',
    ...
    {
      id: 2,
      name: 'Dupliquer Colis',
      description: 'Créer une copie d\'un colis existant avec tous ses détails. Utile pour créer rapidement des colis similaires.',
    ...
    },
    {
      id: 3,
      name: 'Prêt à Payer',
      description: 'Modifier le statut de paiement d\'un colis. Entrez le code de suivi du colis à modifier.',
    ...
    {
      id: 4,
      name: 'Tarifs Supplémentaires',
      description: 'Consulter et mettre à jour les tarifs supplémentaires des colis. Entrez le code de suivi pour gérer les frais additionnels.',
